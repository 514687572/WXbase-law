    ...
    <div id="c-con">
        ...
        <c:if test="${(sessionScope.date!=null && sessionScope.date!='')}" var="condition" scope="request">
            ...
            <div class="c-mcons">
                ...
                <c:if test="${sessionScope.date.gc==false}" var="condition" scope="request">
                	<p class="c-mtimes">目标日:<span>${sessionScope.date.remark3}&nbsp;农历:${sessionScope.date.lunarCh}</span></p>
                </c:if>
	            <c:if test="${sessionScope.date.gc==true}" var="condition" scope="request">
